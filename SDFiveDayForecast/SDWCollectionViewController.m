...
#import "SDWCollectionViewController.h"
#import "AFNetworking.h"
#import "SDCityWeatherData.h"
#import "SDWCollectionViewCell.h"

@interface SDWCollectionViewController ()

@end

@implementation SDWCollectionViewController

- (void)viewDidLoad {
    [super viewDidLoad];
     self.SDWCollectionView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"clouds.png"]];  //sets background image
}
